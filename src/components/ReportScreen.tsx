            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown className={`w-4 h-4 text-[#607994] transition-transform ${showLocationDropdown ? 'rotate-180' : ''}`} />
                </button>
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown className={`w-4 h-4 text-[#607994] transition-transform ${showTimeDropdown ? 'rotate-180' : ''}`} />
                </button>
                {showTimeDropdown && (
                  <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-[#E2E8F0] rounded-xl shadow-lg z-10 max-h-48 overflow-y-auto">
