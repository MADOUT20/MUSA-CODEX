...
export const BottomNav: React.FC<BottomNavProps> = ({ activeTab, onSelectTab }) => {
  ...
  return (
    <nav 
      className="sticky bottom-0 z-40 w-full bg-[#FAFBFD] border-t border-[#DDE5ED] py-1.5 px-3"
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className="flex flex-col items-center justify-center min-w-[60px] py-1 cursor-pointer transition-colors group"
            >
              <div
